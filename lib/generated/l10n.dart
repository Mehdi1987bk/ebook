...
class S {
  ...
  String get comfirmYourPassword {
    return Intl.message(
      'Comfirm your password',
      name: 'comfirmYourPassword',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Sizin Kartiniz yoxdur`
  String get sizinKartinizYoxdur {
    return Intl.message(
      'Sizin Kartiniz yoxdur',
      name: 'sizinKartinizYoxdur',
      desc: '',
      args: [],
    );
  }
