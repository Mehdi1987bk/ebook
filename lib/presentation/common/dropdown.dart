...
const EdgeInsetsGeometry _kUnalignedMenuMargin =
    EdgeInsetsDirectional.only(start: 8.0, end: 24.0);
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Spacer(),
                (itemIndex == route.selectedIndex && !route.isHintVisible)
                    ? Icon(
                        Icons.check,
...
//    WidgetsBinding.instance.addObserver(this);
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      ...
      isHintVisible: _selectedIndex == null,
    ...
    if (widget.hint != null || (!_enabled && widget.disabledHint != null)) {
      final Widget? emplacedHint = _enabled
          ...
          : DropdownMenuItem<Widget>(
              child: widget.disabledHint ?? widget.hint ?? const SizedBox());
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            IconTheme(
             ...
             SizedBox(
              width: widget.iconRightPadding ??  12.0,
            )
          ],
        ),
      ),
