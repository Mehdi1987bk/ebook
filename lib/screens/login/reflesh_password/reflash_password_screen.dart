...
class _ReflashPasswordScreenState
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: S.of(context).emailAdres,
  ...
  _reflash() {
    ...
    bloc.forgot(email).then((value) => Navigator.pushReplacement(context,
        CupertinoPageRoute(builder: (BuildContext context) => PasswordMail())));
  }
}
